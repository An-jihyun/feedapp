...
public class JwtTokenProvider {
	...
	// secretKey 를 Key 객체로 변환, @PostConstruct 는 객체 생성 후 자동으로 이 메서드를 실행하게 한다.
	// HMAC-SHA256 방식에서 서명 키로 사용할 Key 를 준비
	@PostConstruct
	public void init() {
		// Base64 디코딩 추가
	...
	public String createToken(String subject) {
		...
		// subject 는 일반적으로 이메일 또는 사용자 ID로 JWT 에 저장되는 주요 정보
		// 발급 시간과 만료 시간도 설정
		// HS256 알고리즘을 사용해 key 로 서명
